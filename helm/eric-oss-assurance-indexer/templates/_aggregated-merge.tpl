...
*/ -}}
{{- define "eric-oss-assurance-indexer.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-assurance-indexer.mergeAnnotations" -}}
  {{- include "eric-oss-assurance-indexer.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-assurance-indexer.mergeLabels" -}}
  {{- include "eric-oss-assurance-indexer.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
