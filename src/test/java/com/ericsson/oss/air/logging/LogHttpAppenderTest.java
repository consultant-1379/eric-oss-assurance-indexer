...
@TestPropertySource(properties = "logging.config=classpath:logback-http.xml")
public class LogHttpAppenderTest extends LoggingWiremockTestSetup {
    @BeforeEach
    public void setup() {
    ...
    //@Test
    public void checkLoggingHttpAppender() {
