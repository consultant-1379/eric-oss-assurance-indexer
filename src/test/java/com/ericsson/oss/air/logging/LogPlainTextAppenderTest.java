...
@TestPropertySource(properties = "logging.config=classpath:logback-plain-text.xml")
public class LogPlainTextAppenderTest extends AbstractTestSetup {
    @MockBean
    ...
    public void checkLoggingJsonAppender() {
        ...
        Appender<ILoggingEvent> jsonAppender = lc.getLogger("root").getAppender("plain-text");
